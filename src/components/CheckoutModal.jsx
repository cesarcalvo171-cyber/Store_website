...
const WHATSAPP_NUMBER = import.meta.env.VITE_WHATSAPP_NUMBER || '50583898687';
          ...
          <div className="w-full md:w-2/5 p-6 sm:p-8 bg-zinc-50 dark:bg-zinc-950/20 flex flex-col justify-between text-left">
            ...
            <div className="border-t border-zinc-200 dark:border-zinc-800 pt-4 space-y-2 text-xs">
              ...
              <div className="pt-2 border-t border-zinc-200 dark:border-zinc-800 space-y-0.5">
                <div className="flex justify-between font-bold text-zinc-950 dark:text-white text-sm">
                  <span>Total</span>
                  <span>${total.toFixed(2)} USD</span>
                </div>
                <div className="flex justify-between text-zinc-400 dark:text-zinc-500 text-[10px] font-light">
                  <span>Equivale a</span>
                  <span>C${(total * USD_TO_NIO).toFixed(0)} NIO</span>
                </div>
              </div>
